...
> Present Group Members: Vibha Nair, Rowan Tichelaar

> Absent Group Members: Avery Dunham, Jenny Kim
...
```{r}
n_i <- replicate(10000, mean(rbinom(100, 10, 0.5)))
ggplot(data = NULL, aes(x = n_i)) + 
  geom_density() +
  labs(title = paste0("Sample Mean, n = 100", 100, ", 10000 Iterations"))
```


```{r}
n_i <- replicate(10000, mean(rbinom(500, 10, 0.5)))
ggplot(data = NULL, aes(x = n_i)) + 
  geom_density() +
  labs(title = paste0("Sample Mean, n = 100", 100, ", 10000 Iterations"))
```
```{r}
n_i <- replicate(10000, mean(rbinom(1000, 10, 0.5)))
ggplot(data = NULL, aes(x = n_i)) + 
  geom_density() +
  labs(title = paste0("Sample Mean, n = 100", 100, ", 10000 Iterations"))
```
...
se <- sd/sqrt(sample)
pnorm(70.5, mean, se)-pnorm(69.5,mean,se)
```
...
n = 10
p = 0.98
mu_approximation = n*p
sigma_approximation = sqrt(n*p*(1-p))
